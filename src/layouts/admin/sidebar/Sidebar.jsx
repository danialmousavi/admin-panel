  ...
  return (
        ...
        <div className={`mini_sidebar collapsedd bg-dark h-100 ${admincontext.showSidebar ? 'expanded' : ''}`}>
            <ul className="p-0 m-0">
                ...
                <SidebarItems icon='fab fa-pagelines' title='مدیریت گارانتی ها' active={false} targetPath={'/test'}/>
                <SidebarItems icon='fas fa-palette' title='مدیریت رنگ ها' active={false} targetPath={'/test'}/>
                ...
                <SidebarItems icon='fas fa-users' title='مشاهده کاربران' active={false} targetPath={'/test'}/>
                <SidebarItems icon='fas fa-user-tag' title='نقش ها' active={false} targetPath={'/test'}/>
