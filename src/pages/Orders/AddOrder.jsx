        ...
        <ModalsConatainer id={"add_order_modal"} fullScreen={true} title={"اضافه کردن سفارش"}>
            <div className="container">
              <div className="row my-1 justify-content-center">
                ...
                <div className="col-12 col-md-4 col-lg-2 my-1">
                  <input type="text" className="form-control" defaultValue="پرداخت : 500,000 تومان" disabled />
                </div>
                <div className="col-12 col-md-4 col-lg-2 my-1">
                  <input type="text" className="form-control" defaultValue="تخفیف : 5,000 تومان" disabled />
                </div>
                <div className="col-12 col-md-4 col-lg-2 my-1">
